...
Furthermore, the Swedish (Ludvigsson et al., 2021) and Australian (Sundararajan et al., 2004) modification of the Charlson score are implemented as well, and identified by `charlson_icd10_se` and `charlson_icd10_am` respectively.

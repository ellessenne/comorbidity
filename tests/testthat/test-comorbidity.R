...
test_that("charlson checks for its arguments properly", {
  ...
  expect_error(
    comorbidity(x = x, id = "id", code = "code", score = "charlson", assign0 = TRUE)
  )
  expect_error(
...
test_that("comorbidity returns a data.frame", {
  ...
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson", assign0 = "none")
  expect_s3_class(cs, "data.frame")
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
  expect_s3_class(cs, "data.frame")
  cs <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", assign0 = "none")
  expect_s3_class(cs, "data.frame")
  cs <- comorbidity(x = x9, id = "id", code = "code", score = "charlson", assign0 = "none")
  expect_s3_class(cs, "data.frame")
  cs <- comorbidity(x = x9, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
  expect_s3_class(cs, "data.frame")
  cs <- comorbidity(x = x9, id = "id", code = "code", score = "elixhauser", assign0 = "none")
  expect_s3_class(cs, "data.frame")
})
...
test_that("if labelled = TRUE, comorbidity returns variable labels", {
  ...
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson", labelled = TRUE, assign0 = "none")
  expect_false(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", labelled = TRUE, assign0 = "none")
  expect_false(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", labelled = TRUE, assign0 = "none")
  expect_false(is.null(attr(cs, "variable.labels")))
})
...
test_that("if labelled = FALSE, comorbidity does not return variable labels", {
  ...
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
  x9 <- data.frame(
    id = sample(1:5, size = 10 * 5, replace = TRUE),
  ...
  cs <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x9, id = "id", code = "code", score = "charlson", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x9, id = "id", code = "code", score = "charlson_2011", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
  cs <- comorbidity(x = x9, id = "id", code = "code", score = "elixhauser", labelled = FALSE, assign0 = "none")
  expect_true(is.null(attr(cs, "variable.labels")))
})
...
test_that("if factorise = TRUE comorbidity returns factors", {
  ...
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson", factorise = TRUE, assign0 = "none")
  ...
  cs <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", factorise = TRUE, assign0 = "none")
  expect_s3_class(cs$ami, "factor")
  expect_s3_class(cs$chf, "factor")
  expect_s3_class(cs$pvd, "factor")
  expect_s3_class(cs$cevd, "factor")
  ...
  expect_s3_class(cs$index, "factor")
  expect_s3_class(cs$windex, "factor")
  cs <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", factorise = TRUE, assign0 = "none")
  expect_s3_class(cs$chf, "factor")
...
test_that("if factorise = FALSE comorbidity does not return factors", {
  ...
  cs <- comorbidity(x = x, id = "id", score = "charlson", code = "code", factorise = FALSE, assign0 = "none")
  ...
  expect_s3_class(cs$index, "factor")
  expect_s3_class(cs$windex, "factor")
  cs <- comorbidity(x = x, id = "id", score = "charlson_2011", code = "code", factorise = FALSE, assign0 = "none")
  expect_false("factor" %in% class(cs$ami))
  expect_false("factor" %in% class(cs$chf))
  expect_false("factor" %in% class(cs$pvd))
  expect_false("factor" %in% class(cs$cevd))
  ...
  expect_s3_class(cs$index, "factor")
  expect_s3_class(cs$windex, "factor")
  cs <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", factorise = FALSE, assign0 = "none")
  expect_false("factor" %in% class(cs$chf))
...
test_that("comorbidity scores are 0 or 1", {
  ...
  elixhauser10 <- comorbidity(x = dat, id = "record_id", code = "diagnosis_icd_2", score = "elixhauser", icd = "icd10", assign0 = "score", factorise = F, labelled = F, tidy.codes = F)[, 2:32]
  ...
  for (i in seq(25)) {
    ...
    elixhauser10 <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", icd = "icd10", assign0 = "none")[, 2:32]
    expect_true(object = all(elixhauser10 >= 0 & elixhauser10 <= 1))
    charlson10 <- comorbidity(x = x, id = "id", code = "code", score = "charlson", icd = "icd10", assign0 = "none")[, 2:18]
    expect_true(object = all(charlson10 >= 0 & charlson10 <= 1))
    charlson10_2011 <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", icd = "icd10", assign0 = "none")[, 2:18]
    expect_true(object = all(charlson10 >= 0 & charlson10 <= 1))
    x <- data.frame(
      id = sample(1:5, size = 50, replace = TRUE),
      code = sample_diag(50, version = "ICD9_2015"),
    ...
    elixhauser9 <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", icd = "icd9", assign0 = "none")[, 2:32]
    expect_true(object = all(elixhauser9 >= 0 & elixhauser9 <= 1))
    charlson9 <- comorbidity(x = x, id = "id", code = "code", score = "charlson", icd = "icd9", assign0 = "none")[, 2:18]
    expect_true(object = all(charlson9 >= 0 & charlson9 <= 1))
    charlson9_2011 <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", icd = "icd9", assign0 = "none")[, 2:18]
    expect_true(object = all(charlson9 >= 0 & charlson9 <= 1))
  }
})
...
test_that("duplicate codes are not counted twice (or more)", {
  for (i in seq(25)) {
    ...
    x3 <- rbind(x, x, x)
    x4 <- rbind(x, x, x, x)
    cx <- comorbidity(x = x, id = "id", code = "code", score = "charlson", assign0 = "none")
    cx2 <- comorbidity(x = x2, id = "id", code = "code", score = "charlson", assign0 = "none")
    cx3 <- comorbidity(x = x3, id = "id", code = "code", score = "charlson", assign0 = "none")
    cx4 <- comorbidity(x = x4, id = "id", code = "code", score = "charlson", assign0 = "none")
    cxn <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
    cxn2 <- comorbidity(x = x2, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
    cxn3 <- comorbidity(x = x3, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
    cxn4 <- comorbidity(x = x4, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
    ex <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", assign0 = "none")
    ex2 <- comorbidity(x = x2, id = "id", code = "code", score = "elixhauser", assign0 = "none")
    ex3 <- comorbidity(x = x3, id = "id", code = "code", score = "elixhauser", assign0 = "none")
    ex4 <- comorbidity(x = x4, id = "id", code = "code", score = "elixhauser", assign0 = "none")
    ...
    expect_equal(object = cxn, expected = cxn2)
    expect_equal(object = cxn, expected = cxn3)
    expect_equal(object = cxn, expected = cxn4)
    expect_equal(object = cxn2, expected = cxn3)
    expect_equal(object = cxn2, expected = cxn4)
    expect_equal(object = cxn3, expected = cxn4)
    expect_true(object = all(cxn[2:18] >= 0 & cxn[2:18] <= 1))
    expect_true(object = all(cxn2[2:18] >= 0 & cxn2[2:18] <= 1))
    expect_true(object = all(cxn3[2:18] >= 0 & cxn3[2:18] <= 1))
    expect_true(object = all(cxn4[2:18] >= 0 & cxn4[2:18] <= 1))
  ...
  for (i in seq(25)) {
    ...
    x3 <- rbind(x, x, x)
    x4 <- rbind(x, x, x, x)
    cx <- comorbidity(x = x, id = "id", code = "code", icd = "icd9", score = "charlson", assign0 = "none")
    cx2 <- comorbidity(x = x2, id = "id", code = "code", icd = "icd9", score = "charlson", assign0 = "none")
    cx3 <- comorbidity(x = x3, id = "id", code = "code", icd = "icd9", score = "charlson", assign0 = "none")
    cx4 <- comorbidity(x = x4, id = "id", code = "code", icd = "icd9", score = "charlson", assign0 = "none")
    cxn <- comorbidity(x = x, id = "id", code = "code", icd = "icd9", score = "charlson_2011", assign0 = "none")
    cxn2 <- comorbidity(x = x2, id = "id", code = "code", icd = "icd9", score = "charlson_2011", assign0 = "none")
    cxn3 <- comorbidity(x = x3, id = "id", code = "code", icd = "icd9", score = "charlson_2011", assign0 = "none")
    cxn4 <- comorbidity(x = x4, id = "id", code = "code", icd = "icd9", score = "charlson_2011", assign0 = "none")
    ex <- comorbidity(x = x, id = "id", code = "code", icd = "icd9", score = "elixhauser", assign0 = "none")
    ex2 <- comorbidity(x = x2, id = "id", code = "code", icd = "icd9", score = "elixhauser", assign0 = "none")
    ex3 <- comorbidity(x = x3, id = "id", code = "code", icd = "icd9", score = "elixhauser", assign0 = "none")
    ex4 <- comorbidity(x = x4, id = "id", code = "code", icd = "icd9", score = "elixhauser", assign0 = "none")
    expect_equal(object = cx, expected = cx2)
    expect_equal(object = cx, expected = cx3)
    expect_equal(object = cx, expected = cx4)
    expect_equal(object = cx2, expected = cx3)
...
test_that("input dataset with additional columns", {
  ...
  c <- comorbidity(x = x, id = "id", code = "code", score = "charlson", assign0 = "none")
  c2 <- comorbidity(x = x2, id = "id", code = "code", score = "charlson", assign0 = "none")
  expect_equal(object = c2, expected = c)
  cn <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
  cn2 <- comorbidity(x = x2, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
  expect_equal(object = c2, expected = c)
  e <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", assign0 = "none")
  e2 <- comorbidity(x = x2, id = "id", code = "code", score = "elixhauser", assign0 = "none")
  ...
  x2 <- x
  x2$noise <- rnorm(n = nrow(x2))
  c <- comorbidity(x = x, id = "id", code = "code", icd = "icd9", score = "charlson", assign0 = "none")
  c2 <- comorbidity(x = x2, id = "id", code = "code", icd = "icd9", score = "charlson", assign0 = "none")
  expect_equal(object = c2, expected = c)
  cn <- comorbidity(x = x, id = "id", code = "code", icd = "icd9", score = "charlson_2011", assign0 = "none")
  cn2 <- comorbidity(x = x2, id = "id", code = "code", icd = "icd9", score = "charlson_2011", assign0 = "none")
  expect_equal(object = c2, expected = c)
  e <- comorbidity(x = x, id = "id", code = "code", icd = "icd9", score = "elixhauser", assign0 = "none")
  e2 <- comorbidity(x = x2, id = "id", code = "code", icd = "icd9", score = "elixhauser", assign0 = "none")
  expect_equal(object = e2, expected = e)
})
...
test_that("all comorbidities", {
  ...
  icd10_2011$id <- 1
  c <- comorbidity(x = icd10_2011, id = "id", code = "Code", icd = "icd10", score = "charlson", assign0 = "score")
  cn <- comorbidity(x = icd10_2011, id = "id", code = "Code", icd = "icd10", score = "charlson_2011", assign0 = "score")
  e <- comorbidity(x = icd10_2011, id = "id", code = "Code", icd = "icd10", score = "elixhauser", assign0 = "score")
  expect_true(object = all(c[2:18] == 1))
  expect_true(object = all(cn[2:18] == 1))
  expect_true(object = all(e[2:32] == 1))
  data("icd10_2009", package = "comorbidity")
  icd10_2009$id <- 1
  c <- comorbidity(x = icd10_2009, id = "id", code = "Code", icd = "icd10", score = "charlson", assign0 = "score")
  cn <- comorbidity(x = icd10_2009, id = "id", code = "Code", icd = "icd10", score = "charlson_2011", assign0 = "score")
  e <- comorbidity(x = icd10_2009, id = "id", code = "Code", icd = "icd10", score = "elixhauser", assign0 = "score")
  expect_true(object = all(c[2:18] == 1))
  expect_true(object = all(cn[2:18] == 1))
  expect_true(object = all(e[2:32] == 1))
  data("icd9_2015", package = "comorbidity")
  icd9_2015$id <- 1
  c <- comorbidity(x = icd9_2015, id = "id", code = "Code", icd = "icd9", score = "charlson", assign0 = "score")
  cn <- comorbidity(x = icd9_2015, id = "id", code = "Code", icd = "icd9", score = "charlson_2011", assign0 = "score")
  e <- comorbidity(x = icd9_2015, id = "id", code = "Code", icd = "icd9", score = "elixhauser", assign0 = "score")
  expect_true(object = all(c[2:18] == 1))
  expect_true(object = all(cn[2:18] == 1))
  expect_true(object = all(e[2:32] == 1))
})
...
test_that("break output checks", {
  ...
  cxn <- comorbidity(x = x, id = "id", code = "code", score = "charlson_2011", assign0 = "none")
  cxn[2:18] <- cxn[2:18] + rnorm(n = nrow(cx))
  expect_error(.check_output(x = cxn, id = "id", score = "charlson_2011"), regexp = "unexpected state")
  ex <- comorbidity(x = x, id = "id", code = "code", score = "elixhauser", assign0 = "none")
...
test_that("works ok with data.table", {
  ...
  c <- comorbidity(x = x, id = "id", code = "code", score = "charlson", assign0 = "none")
  c.dt <- comorbidity(x = data.table::setDT(x), id = "id", code = "code", score = "charlson", assign0 = "none")

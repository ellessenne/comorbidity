...
get_ahrq_2022 = function(
  ...
  #   /*                                                                */
  #   /* Program:     Mapping_Program_v2022-1.SAS                   */
  #   /*                                                                */
  ...
  #   /*                                                                */
  #   /* Note:	    The SAS program Format_Program_v2022-1 must   */
  ...
  #          IF DXVALUE = "DRUG_ABUSEPSYCHOSES"  THEN DRUG_ABUSE= 1;
  dt[DRUG_ABUSEPSYCHOSES==1, DRUG_ABUSE := 1]
  #          IF DXVALUE = "HFHTN_CX"             THEN HTN_CX    = 1;
  dt[HFHTN_CX==1, HTN_CX := 1]
  #          IF DXVALUE = "HTN_CXRENLFL_SEV"     THEN HTN_CX    = 1;
  dt[HTN_CXRENLFL_SEV==1, HTN_CX := 1]
  #          IF DXVALUE = "HFHTN_CXRENLFL_SEV"   THEN HTN_CX    = 1;
  ...
  if (poa) {
    ...
    dt[(EXEMPTPOA==1 | (EXEMPTPOA==0 & poa_code %in% c('Y', 'W'))) &
         ALCOHOLLIVER_MLD==1,
       LIVER_MLD := 1]
    #             IF DXVALUE = "VALVE_AUTOIMMUNE"    THEN VALVE     = 1;
    dt[(EXEMPTPOA==1 | (EXEMPTPOA==0 & poa_code %in% c('Y', 'W'))) &
         VALVE_AUTOIMMUNE==1,
       VALVE := 1]
